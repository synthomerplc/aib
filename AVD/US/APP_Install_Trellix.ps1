...
Install-Application -url 'https://staibsources002.blob.core.windows.net/applications/Live/Trellix%20(Mcafee)/FramePkg.exe' -fileName 'FramePkg.exe' -arguments @('/install=agent', '/s')
Start-Sleep 120

# Clear GUID (for sysprep)
LogWrite "AIB Customisation: Running command to clear GUID for $appName"
Start-Process -FilePath "C:\Program Files\McAfee\Agent\maconfig.exe" -ArgumentList "-enforce", "-noguid" -Wait -NoNewWindow
