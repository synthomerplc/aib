...
Install-Application -url 'https://staibsources002.blob.core.windows.net/applications/Live/SAP%202021/Install.zip' -fileName 'Install.zip' -arguments @('/Silent', '/Package="pathway_2021"')
Start-Sleep 2
